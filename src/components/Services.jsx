    ...
    <section id='services' className='services__section relative'>
      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8 pb-20'>
        ...
        <p className='mx-auto text-whiteColor mt-10 max-w-2xl text-center text-lg leading-8 '>
          With more than 30 years of collective plumbing expertise, Katys
          Plumbing Service is your go-to for resolving all your plumbing issues
          promptly and affordably. Trust our skilled plumbers to provide
          effective solutions for your plumbing problems.
        </p>
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={classNames(
                ...
                `rounded-3xl bg-gray-300 bg-opacity-20  p-8
