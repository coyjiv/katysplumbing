  ...
  return (
    <section className="bg-[url('https://images.unsplash.com/photo-1538474705339-e87de81450e8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')] bg-fixed bg-cover py-40 min-h-[80vh] text-whiteColor">
      ...
      <div className="container mx-auto px-4 lg:px-20 relative z-10">
        ...
        <animated.a
          href="#"
          className="block  drop-shadow-md shadow-lg w-fit border font-display bg-white text-gray-800 px-8 py-4 rounded-full uppercase tracking-wider font-bold hover:bg-gray-100 transition duration-300"
          style={props2}
        >
          Schedule Service
        </animated.a>
        <animated.a
          href="#"
          className=" drop-shadow-md shadow-lg mt-5 block w-fit border font-display bg-white text-gray-800 px-8 py-4 rounded-full uppercase tracking-wider font-bold hover:bg-gray-100 transition duration-300"
          style={props3}
        >
          About us
        </animated.a>
